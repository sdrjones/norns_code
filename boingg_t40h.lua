...
local function draw_cycle(x, stage)
  if t40h.connected() then
    for y = 1 , GRID_HEIGHT do
      t40h:led(x, y, (y == cycles[x].led_pos) and 15 or 0)
    end
  end
end
